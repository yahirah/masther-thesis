...
\def\thesisauthor  {Anna Maria Walach (s121540)}
\def\thesistitle   {Development of a game for hand- and eye coordination in children rehabilitation.}
\def\thesissubtitle{Analysis, implementation and testing.}
